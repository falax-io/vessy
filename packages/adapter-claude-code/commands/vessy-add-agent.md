---
description: Add a new agent to .vessy/agents/ interactively
allowed-tools: ["Write"]
---

Add a new agent definition by gathering information conversationally, then writing the YAML file directly.

Do NOT use the CLI for this command.
